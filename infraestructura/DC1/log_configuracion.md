...
La cuestión es que nuestra elección se basará en la complejidad que necesito en el servidor de ficheros. Como la infraestructura será un instituto, los recursos van a ser accedidos por distintos grupos, por lo que necesitaremos SMB+winbind debido a que sí soporta ACLs, que serán necesarias.
...
samba-tool group addmembers GRP_PROFESORES GRP_1ASIR_PROFESORES
samba-tool group addmembers GRP_PROFESORES GRP_2ASIR_PROFESORES
samba-tool group addmembers GRP_PROFESORES GRP_1DAW_PROFESORES
